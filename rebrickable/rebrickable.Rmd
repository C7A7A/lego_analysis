...
<strong>Log10(Number of Parts)</strong> is used instead of just displaying Number of Parts because difference between <strong>Plastic</strong> and other materials is so big that they would be almost invisible on plot.
```{r}
...
We will remove some rows from sets_df which has really high Number of Parts. They diverge significantly from other values, making our graph unreadable.
```{r}
